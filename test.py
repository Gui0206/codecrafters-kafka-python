...
# Passo 2: Criamos um Handler que agrupa a função de array e a validação
class ApiVersionsHandler:
...
def main():
    ...
    # Passo 2: Delegamos a regra de negócio para o Handler
